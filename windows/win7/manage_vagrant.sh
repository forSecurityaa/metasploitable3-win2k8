...
function vagrant_box_add {
  ...
  vagrant box add .cache/IE11\ -\ Win7.box --name localhost/$boxname
...
function main {
  ...
  export boxname=IE11Win7
  export boxurl=https://az792536.vo.msecnd.net/vms/VMBuild_20150916/Vagrant/IE11/IE11.Win7.Vagrant.zip
  local i
  local new_array=( $@ )
  for ((i=0;i<$#;i++)); do
